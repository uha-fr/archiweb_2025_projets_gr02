    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <div class="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div class="bg-gray-50 px-4 py-4 sm:px-6">
                    <div class="text-sm">
                        <a href="{{ route('offers.index') }}" class="font-medium text-primary-600 hover:text-primary-500">
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                ...
                <div class="bg-gray-50 px-4 py-4 sm:px-6">
                    <div class="text-sm">
                        <a href="{{ route('history') }}" class="font-medium text-primary-600 hover:text-primary-500">
                            Voir l'historique
                        </a>
                    </div>
                </div>
        ...
        <div class="mt-8">
            <div class="flex items-center justify-between">
                <h2 class="text-lg leading-6 font-medium text-gray-900">Offres récentes</h2>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                                                Aucune offre récente. <a href="{{ route('offers.create') }}" class="text-primary-600 hover:text-primary-900">Créer une offre</a>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
        ...
        <div class="mt-8">
            <div class="flex items-center justify-between">
                <h2 class="text-lg leading-6 font-medium text-gray-900">Contrats récents</h2>
                <a href="{{ route('history') }}" class="text-sm font-medium text-primary-600 hover:text-primary-500">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">
                                                    ...
                                                    @endif
                                                    {{ $contract->offer->quantity }} kWh à {{ $contract->offer->price }} €/kWh
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">
                                                    @if ($contract->buyer_id == Auth::id())
                                                        Vendeur: {{ $contract->seller->name }}
                                                    @else
                                                        Acheteur: {{ $contract->buyer->name }}
                                                    @endif
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
